...
//                 .andExpect(jsonPath("$.userId", equalTo(58)))
...
//                 .andExpect(jsonPath("$.results[0].userId", equalTo(58)))
//                 .andExpect(jsonPath("$.results[0].totalAmount", equalTo(630)))
